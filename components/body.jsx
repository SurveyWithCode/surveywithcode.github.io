...
export default function Body({ children }) {
  return (
    <div className="mx-auto flex max-w-[90rem] px-2 sm:px-4">
      ...
      {/* <Sidebar/> */}
      {/* <nav className="swr-toc order-last max-xl:hidden w-64 shrink-0 print:hidden px-4" aria-label="table of contents">
                <div className="swr-scrollbar sticky top-16 overflow-y-auto pr-4 pt-6 text-sm [hyphens:auto] max-h-[calc(100vh-var(--swr-navbar-height)-env(safe-area-inset-bottom))] ltr:-mr-4 rtl:-ml-4">
                    ...
                    <div className="swr-toc-footer mt-8 pt-8 sticky bottom-0 flex flex-col items-start gap-2 pb-8">
      ...
      <article className="w-full break-words swr-content flex min-h-[calc(100vh-var(--swr-navbar-height))] min-w-0 justify-center pb-8 pr-0 sm:pr-[calc(env(safe-area-inset-right)-1.5rem)]">
        {children}
      </article>
    </div>
  )
