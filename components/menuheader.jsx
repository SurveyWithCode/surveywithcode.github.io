...
export default function MenuHeader() {
  return (
    <div className="flex gap-4 overflow-x-auto swr-scrollbar py-1.5 max-md:hidden">
      <a
        className="focus-visible:swr-focus text-sm contrast-more:text-gray-700 contrast-more:dark:text-gray-100 whitespace-nowrap text-gray-600 hover:text-black dark:text-gray-400 dark:hover:text-gray-200 ring-inset transition-colors aria-[current]:font-medium aria-[current]:subpixel-antialiased aria-[current]:text-current"
        href="/taxonomy"
      >
        Taxonomy
      </a>
